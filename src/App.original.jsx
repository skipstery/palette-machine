...
const DEFAULT_STOPS = [
  { name: "0", L: 100, C: 0.02 },
  { name: "50", L: 97, C: 0.04 },
  { name: "100", L: 93, C: 0.09 },
  { name: "200", L: 85, C: 0.14 },
  { name: "300", L: 78, C: 0.17 },
  { name: "400", L: 70, C: 0.19 },
  { name: "500", L: 63, C: 0.2 },
  { name: "600", L: 58, C: 0.19 },
  { name: "700", L: 54, C: 0.17 },
  { name: "800", L: 44, C: 0.14 },
  { name: "900", L: 32, C: 0.09 },
  { name: "950", L: 28, C: 0.04 },
  { name: "1000", L: 25, C: 0.02 },
];

const DEFAULT_HUES = [
  { name: "gray", H: 0, fullGray: true },
  { name: "red", H: 25, fullGray: false },
  ...
  { name: "blue", H: 250, fullGray: false },
  { name: "indigo", H: 270, fullGray: false },
...
const STORAGE_KEY = "sirvui-palette-config";
const MAX_HISTORY = 50;

// InfoBlock component for collapsible explanatory sections
const InfoBlock = ({ title, isOpen, onToggle, children, variant = "info" }) => {
  const bgColors = {
...
// Helper to render formatted description text
...
// Section component for config areas
const ConfigSection = ({
  title,
  description,
  isOpen,
